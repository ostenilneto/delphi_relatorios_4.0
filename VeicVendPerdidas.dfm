object FrmVeicVendPerdidas: TFrmVeicVendPerdidas
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Ve'#237'culos - Vendas Perdidas'
  ClientHeight = 561
  ClientWidth = 1184
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object GridResult: TDBGrid
      ...
      Height = 211
      Align = alBottom
      DataSource = DataModule1.DtsVVendPerd
      TabOrder = 0
  ...
  object Panel4: TPanel
    ...
    object GridMensal: TDBGrid
      ...
      Height = 211
      Align = alBottom
      DataSource = DataModule1.DtsVVendPerd_mes
      TabOrder = 0
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
      TitleFont.Height = -11
