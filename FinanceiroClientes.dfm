object FrmFinanceiroClientes: TFrmFinanceiroClientes
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Relat'#243'rio Financeiro Clientes'
  ClientHeight = 561
  ClientWidth = 1184
  Color = clBtnFace
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = 'Clientes com saldo ativo'
      object GridClientes1: TDBGrid
        Left = 0
        Top = 0
        Width = 1176
        Height = 476
        Align = alClient
        DataSource = DataModule1.DtsClientes1
        TabOrder = 0
        ...
        TitleFont.Style = []
        OnTitleClick = GridClientes1TitleClick
      end
    end
    object TabSheet2: TTabSheet
      Caption = 'Clientes com limite = 0'
      ImageIndex = 1
      object GridClientes2: TDBGrid
        Left = 0
        Top = 0
        Width = 1176
        Height = 476
        Align = alClient
        DataSource = DataModule1.DtsClientes2
        TabOrder = 0
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnTitleClick = GridClientes2TitleClick
      end
    end
    object TabSheet3: TTabSheet
      Caption = 'Clientes com limite > 0'
      ImageIndex = 2
      object GridClientes3: TDBGrid
        Left = 0
        Top = 0
        Width = 1176
        Height = 476
        Align = alClient
        DataSource = DataModule1.DtsClientes3
        TabOrder = 0
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnTitleClick = GridClientes3TitleClick
      end
    end
    object TabSheet4: TTabSheet
      Caption = 'Clientes com limite < 0'
      ImageIndex = 3
      object GridClientes4: TDBGrid
        Left = 0
        Top = 0
        Width = 1176
        Height = 476
        Align = alClient
        DataSource = DataModule1.DtsClientes4
        TabOrder = 0
        TitleFont.Charset = DEFAULT_CHARSET
        TitleFont.Color = clWindowText
        TitleFont.Height = -11
        TitleFont.Name = 'Tahoma'
        TitleFont.Style = []
        OnTitleClick = GridClientes4TitleClick
      end
    end
  end
end
