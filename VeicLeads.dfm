object FrmVeicLeads: TFrmVeicLeads
  Left = 0
  Top = 0
  Caption = 'Ve'#237'culos - Leads'
  ClientHeight = 561
  ClientWidth = 1184
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      Font.Name = 'Arial'
      Font.Style = []
      KeyField = 'ORIGEM_TRAFEGO'
      ListField = 'DES_ORIGEM_TRAFEGO'
      ListFieldIndex = 1
      ListSource = DataModule1.DtsOrigem_Trafego
      ParentFont = False
      TabOrder = 7
    end
    object DBLookupComboBox2: TDBLookupComboBox
      ...
      KeyField = 'USUARIO'
      ListField = 'NOME'
      ListSource = DataModule1.DtsCad_Vendedor
      ParentFont = False
      TabOrder = 8
    end
  end
  object Panel2: TPanel
    ...
    object GridResult: TDBGrid
      ...
      Height = 211
      Align = alBottom
      DataSource = DataModule1.DtsLeads_
      TabOrder = 0
  ...
  object Panel4: TPanel
    ...
    object Label3: TLabel
      ...
      Width = 170
      Height = 13
      Caption = 'Mensal (Conforme filtros de datas):'
    end
    object GridMensal: TDBGrid
      Left = 1
      Top = 24
      Width = 1182
      Height = 211
      Align = alBottom
      DataSource = DataModule1.DtsLeads
      TabOrder = 0
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
      TitleFont.Height = -11
