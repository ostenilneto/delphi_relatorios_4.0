object FrmVeicCRM: TFrmVeicCRM
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'A'#231#245'es CRM'
  ClientHeight = 561
  ClientWidth = 1184
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DBLookupComboBox1: TDBLookupComboBox
      ...
      Font.Style = []
      KeyField = 'FAMILIA'
      ListField = 'DES_FAMILIA'
      ListFieldIndex = 1
      ListSource = DataModule1.DtsVeicFamilia
      ParentFont = False
      TabOrder = 6
    end
