object FrmObsoleto: TFrmObsoleto
  Left = 0
  Top = 0
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Controle de pe'#231'as obsoletas'
  ClientHeight = 561
  ClientWidth = 1184
  Color = clBtnFace
  ...
  object GridObsoleto: TDBGrid
    Left = 0
    Top = 57
    Width = 1184
    Height = 504
    Align = alClient
    DataSource = DataModule1.DtsObsoleto
    TabOrder = 1
    ...
    TitleFont.Style = []
    OnTitleClick = GridObsoletoTitleClick
  end
end
